function [dh,h,cp,zq,leaders,structfunc] = dwtleader2(x,varargin)

%Multifractal 1-D Wavelet Leader Estimates
% Before going through this, make sure you execute  this command : "dwtmode('zpd')"
...
narginchk(1,6)
nargoutchk(0,6)
validateattributes(x,{'numeric'},{'finite','nonempty'});
...
[leaders,scales,ncount] =dwtleaders2(x,Lo,Hi);
...
for jj = 1:Nest
    [zetaq(:,jj),Dq(:,jj), Hq(:,jj), Cp(:,jj)] = ...
        mfstructfunctions2(abs(leaders{jj}),params);
end
