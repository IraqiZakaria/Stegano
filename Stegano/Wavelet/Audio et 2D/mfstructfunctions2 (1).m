function [zetaq,Dq, Hq, Cp] = mfstructfunctions2(wavcoefs, param)
% Elle reste pareille, mais je la mets comme ça au cas où....
...
q = param.q;
q = q(:) ;   % Bon de taille 11 d'habitude
numcoefs = numel(wavcoefs);
nq=length(q);
% Create matrices for computation
% Ce qu'il me reste à corriger
S = repmat(wavcoefs',nq,1);                   %wavcoefs lignes*nq
